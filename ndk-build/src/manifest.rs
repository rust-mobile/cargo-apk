...
pub struct Application {
    ...
    #[serde(rename = "activity", alias = "activities")]
...
pub struct Activity {
    ...
    #[serde(default = "default_activity_name", alias = "")]
    pub name: String,
...
pub struct IntentFilter {
    #[serde(rename = "action", alias = "actions")]
    #[serde(default)]
    pub actions: Vec<Action>,
    #[serde(rename = "category", alias = "categories")]
    #[serde(default)]
...
/// Android [intent filter action element](https://developer.android.com/guide/topics/manifest/action-element).
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct Action {
...
/// Android [intent filter category element](https://developer.android.com/guide/topics/manifest/category-element).
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct Category {
    #[serde(rename = "android:name")]
    pub name: String,
